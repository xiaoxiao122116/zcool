...
(function (t, i) {
        ...
        checkDimensions: function () {
            if (this.dropdown.length) {
                var i = this.dropdown.css("margin-" + t.UIkit.langdirection, "").css("min-width", ""),
                    e = i.show().offset(), n = i.outerWidth(), s = this.boundary.width(),
        ...
        options: {target: !1}, match: function () {
            ...
            if (i.length) {
                ...
                if (!e)return this.elements.each(function () {
                    ...
                    var e = t(this), o = "border-box" == e.css("box-sizing") ? "outerHeight" : "height",
                        a = s.columns.eq(i), r = e.height() + (n - a[o]());
    ...
    var e, n = t(window), s = t(document), o = {
        show: function (i) {
            if (i = t(i), i.length) {
                var a = t("html"), r = i.find(".uk-offcanvas-bar:first"),
        ...
        tip: "", options: {
            ...
            if (this.tip.length) {
                ...
                var i = t.extend({}, this.element.offset(), {
                    ...
                    r = {display: "none", visibility: "visible", top: i.top + i.height + s, left: i.left},
                    l = a.split("-");
